#-*- coding:utf-8 -*-
#来自博客：http://blog.csdn.net/thriving_fcl/article/details/74165062
...
class Seq2SeqModel(object):
    ...
    def __init__(self, rnn_size, layer_size, encoder_vocab_size,decoder_vocab_size, embedding_dim, grad_clip, is_inference=False):
        # define inputs
        self.input_x = tf.placeholder(tf.int32, shape=[None, None], name='input_ids')   #可以这样写 shape=[None,None]
        ...
        with tf.device('/cpu:0'):
            input_x_embedded = tf.nn.embedding_lookup(encoder_embedding, self.input_x)   #可以用
    ...
    def _get_simple_lstm(self, rnn_size, layer_size):  #获取一个多层的
