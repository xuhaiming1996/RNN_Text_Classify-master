...
def load_data(f):
    train_source_set, length_array_eachdoc_source, max_source_sen_num, max_source_word_num, num_doc=read_file(f)
...
def batch_iter(data_source,batch_size)
    ...
    for batch_index in range(num_batches_per_epoch):
        ...
        if end_index - start_index != batch_size:  # 说明最后一个batch
